...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'branch', 'as' => 'branch.'], function () {
            ...
            Route::get('status/{user_id}/{status_code}', 'BranchController@status')->name('status');

            Route::post('update/{id}', 'BranchController@update')->name('update');
            Route::delete('delete/{id}', 'BranchController@delete')->name('delete');
        });
        Route::group(['prefix' => 'table', 'as' => 'table.'], function () {
            Route::get('add-new', 'TableController@index')->name('add-new');
        ...
        Route::group(['prefix' => 'ingredient', 'as' => 'ingredient.'], function () {
            Route::get('add-new', 'IngredientController@index')->name('add-new');
            Route::get('list', 'IngredientController@list')->name('list');
            ...
            //ajax request 
            Route::get('get-categories', 'IngredientController@get_categories')->name('get-categories');
        });
        Route::group(['prefix' => 'productcompose', 'as' => 'productcompose.'], function () {
            Route::get('add-new', 'ProductComposeController@index')->name('add-new');
            Route::get('list', 'ProductComposeController@list')->name('list');
            //Route::get('ajouter', 'ProductComposeController@ajouter')->name('ajouter');
            //Route::post('ajouter', 'ProductComposeController@ajouter')->name('ajouter');
            Route::post('ajouter', 'ProductComposeController@ajouter')->name('ajouter');

            Route::post('store', 'ProductComposeController@store')->name('store');
            Route::get('edit/{id}', 'ProductComposeController@edit')->name('edit');
            Route::post('update/{id}', 'ProductComposeController@update')->name('update');
            Route::delete('delete/{id}', 'ProductComposeController@delete')->name('delete');

            //ajax request 
            //   Route::get('get-categories', 'IngredientController@get_categories')->name('get-categories');
        });

        Route::group(['prefix' => 'formule', 'as' => 'formule.'], function () {
            Route::get('add', 'FormuleController@index1')->name('add');
            Route::post('store', 'FormuleController@store')->name('store');
            Route::get('list', 'FormuleController@list')->name('list');
            Route::get('edit/{id}', 'FormuleController@edit')->name('edit');
            Route::post('update/{id}', 'FormuleController@update')->name('update');
            Route::delete('delete/{id}', 'FormuleController@delete')->name('delete');
        });
        ...
        Route::group(['prefix' => 'product', 'as' => 'product.'], function () {
            ...
            Route::get('add', 'ProductController@index1')->name('add');
            Route::post('store', 'ProductController@store')->name('store');


            Route::post('variant-combination', 'ProductController@variant_combination')->name('variant-combination');
            Route::post('ajouter', 'ProductController@ajouter')->name('ajouter');
        ...
        Route::group(['prefix' => 'ingcategory', 'as' => 'ingcategory.'], function () {
            Route::get('add', 'IngCategoryController@index')->name('add');
            Route::post('store', 'IngCategoryController@store')->name('store');
            Route::get('edit/{id}', 'IngCategoryController@edit')->name('edit');
            Route::post('update/{id}', 'IngCategoryController@update')->name('update');
            //  Route::post('store', 'CategoryController@store')->name('store');
            Route::get('status/{id}/{status}', 'IngCategoryController@status')->name('status');
            Route::delete('delete/{id}', 'IngCategoryController@delete')->name('delete');
            //  Route::post('search', 'IngCategoryController@search')->name('search');
        });
