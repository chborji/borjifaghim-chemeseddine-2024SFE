...
class Helpers
{
    ...
    public static function product_data_formatting($data, $multi_data = false)
    {
        ...
        if ($multi_data == true) {
            foreach ($data as $item) {
                ...
                $item['ingredients'] = Ingredient::whereIn('id', json_decode($item['ingredients']))->get();
            ...
            $data['ingredients']=Ingredient::whereIn('id', json_decode($data['ingredients']))->get();;
    ...
    public static function selected_ingredients($ingredients) {
        $selected_ingredients = [];

        if ($ingredients) {
            foreach ($ingredients as $ingredient ) {
                array_push($selected_ingredients, $ingredient->id);
            }
           
        }
    
        return ['ingredients' => $selected_ingredients];
