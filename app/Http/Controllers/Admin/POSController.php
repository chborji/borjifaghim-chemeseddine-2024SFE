...
class POSController extends Controller
{
    ...
    { 
        ...
        $order->coupon_discount_amount = $request->coupon_discount_amount == 0 ? null : 'ccoupon_discount_amount';
            ...
            if (is_array($c)) {
                ...
                if ($product) {
                    ...
                    $or_d = [
                        ...
                        'created_at' => now(),
                        'updated_at' => now(),
                        /* 'formule_details' => null,
                        'compose_details'=> null,
                        'formule_id' =>null, */
