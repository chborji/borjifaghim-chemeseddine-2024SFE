        ...
        <div class="col-12">
            <table class="table">
                <tbody>
                    ...
                    @if(isset($product))
                    <tr colspan="0"onclick="location.href='{{route('admin.product.view',[$item['product_id']])}}'" style="cursor: pointer">
                        <td scope="row">
                            <img height="35" style="border-radius: 5px" src="{{asset('storage/product')}}/{{ $item->product->image ?? '' }}" alt="{{$product->name}} image">
                            <span class="ml-2">
