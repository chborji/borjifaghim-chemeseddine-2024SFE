                ...
                <div class="media-body">
                    <div class="row">
                        <div class="col-lg mb-3 mb-lg-0">
                            <h1 class="page-header-title">{{\App\CentralLogics\translate('rapport')}} de {{\App\CentralLogics\translate('vente')}} </h1>
            ...
            <span class="hs-nav-scroller-arrow-prev" style="display: none;">
              ...
              <a class="hs-nav-scroller-arrow-link" href="javascript:;">
                ...
                <ul class="nav nav-tabs page-header-tabs" id="projectsTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" href="javascript:">{{\App\CentralLogics\translate('apperçu')}}</a>
                    </li>
                </ul>
            </div>
            <!-- End Nav -->
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <select class="custom-select custom-select" name="branch_id" id="branch_id"
                                            required>
                                        <option selected disabled>caissier</option>
                                ...
                                <div class="col-2">
                                    <button type="submit"
                                            class="btn btn-primary btn-block">{{\App\CentralLogics\translate('afficher')}}</button>
                                </div>

                                <div class="col-md-6 pt-4">
                                    <strong>
                                        {{\App\CentralLogics\translate('total')}} {{\App\CentralLogics\translate('commandes')}} : <span
                                            id="order_count"> </span>
                                    </strong><br>
                                    <strong>
                                    ...
                                    <strong>{{\App\CentralLogics\translate('total')}}  {{\App\CentralLogics\translate('montant')}} : <span
