<div class="table-responsive datatable-custom">
    <table id="datatable"
        ...
        <tr>
            ...
            <td>{{\App\CentralLogics\translate('commande')}}</td>
        ...
        @foreach($data as $key=>$row)
            <tr>
                ...
                <td>
                    @if($row['customer'])
                        <a class="text-body text-capitalize" href="{{route('admin.customer.view',[$row['customer']['id']])}}">{{$row['customer']->f_name.' '.$row['customer']->l_name}}</a>
                    @else
                        <label
