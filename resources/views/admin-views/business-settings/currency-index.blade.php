            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{route('admin.business-settings.currency-add')}}" method="post"
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="text" placeholder="ex : Tunisia" class="form-control" name="country">
                    </div>

                    <div class="form-group mb-2">
                        <label style="padding-left: 10px">Code</label><br>
                        <input type="text" placeholder="ex : EUR" class="form-control" name="currency_code">
                    </div>
                    ...
                    <div class="form-group mb-2">
                        <label style="padding-left: 10px">Exchange Rate</label><br>
            ...
            <div class="table-responsive datatable-custom">
                <table id="columnSearchDatatable"
                    ...
                    <tr>
                        <th></th>
                        <th>
                            <input type="text" id="column1_search" class="form-control form-control-sm" placeholder="Search country">
                        </th>
                        <th>
