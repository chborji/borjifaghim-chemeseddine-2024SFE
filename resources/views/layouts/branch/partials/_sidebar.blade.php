            ...
            <div class="navbar-vertical-footer-offset">
                ...
                <div class="navbar-vertical-content text-capitalize">
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <li class="nav-item">
                            <small
                                class="nav-subtitle">{{\App\CentralLogics\translate('Système')}} {{\App\CentralLogics\translate('POS')}}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>

                    <!-- POS -->
                        <li class="navbar-vertical-aside-has-menu {{Request::is('branch/pos/*')?'active':''}}">
                            <a class="js-navbar-vertical-aside-submenu   nav-link {{-- nav-link-toggle --}} " {{-- href="javascript:" --}} href="{{route('branch.pos.index')}}">
                                <i class="tio-shopping nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{\App\CentralLogics\translate('POS')}}</span>
                            </a>
                        {{--    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"style="display: {{Request::is('branch/pos/*')?'block':'none'}}">
                        ...
                        <li class="nav-item ">
                            <small class="nav-subtitle" title="Pages">{{\App\CentralLogics\translate('Section')}} {{\App\CentralLogics\translate('Cammandes')}}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>
                        ...
                        <li class="{{-- navbar-vertical-aside-has-menu --}} {{Request::is('branch/orders*')?'active':''}}">
                            ...
                            {{-- <ul class="js-navbar-vertical-aside-submenu nav nav-sub"style="display: {{Request::is('branch*')?'block':'none'}}">
