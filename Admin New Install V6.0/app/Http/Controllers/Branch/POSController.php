 ...
 */
    ...
    public function addToCart(Request $request)
    {
        ...
        $data['add_ons'] = [];
        $data['add_on_qtys'] = [];
       $data['ingredients']=$request['ingredient_id'];
    ...
    public function place_order(Request $request)
    {
        ...
        $order->coupon_discount_amount = $request->coupon_discount_amount == 0 ? null : 'coupon_discount_amount';
        ...
        foreach ($cart as $c) {
            if (is_array($c)) {
                ...
                if ($product) {
                    ...
                    $ingredient_ids = isset($c['ingredients']) ? $c['ingredients'] : [];
                $ingredient_data = Helpers::selected_ingredients(Ingredient::whereIn('id', $ingredient_ids)->get());
                    ...
                    $or_d = [
                        ...
                        'ingredients' => json_encode($ingredient_data['ingredients']), // fix here
                        'created_at' => now(),
                        'updated_at' => now()
                    ];
