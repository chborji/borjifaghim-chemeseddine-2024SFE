...
class BusinessSettingsController extends Controller
{
    ...
    public function restaurant_setup(Request $request)
    {
      ...
      /*   if (in_array('fr', $languages)) {
            unset($languages[array_search('fr', $languages)]);
        } 
        array_unshift($languages, 'fr');*/
        ...
        Toastr::success('Mise à jour des paramètres');
        return back();
    }
    ...
    public function mail_config(Request $request)
    {
        ...
        Toastr::success('La configuration a été mise à jour avec succès');
        return back();
    }
    ...
    public function payment_update(Request $request, $name)
    {
        ...
        Toastr::success('mise à jour des paramètres de paiement ');
        return back();
    }
    ...
    public function currency_store(Request $request)
    {
        ...
        Toastr::success('Monnaie ajoutée avec succès ');
        return back();
    }
    ...
    public function currency_update(Request $request, $id)
    {
        ...
        Toastr::success('La monnaie a été mise à jour avec succès');
    ...
    public function currency_delete($id)
    {
        ...
        Toastr::success('La monnaie a été supprimée avec succès');
        return back();
    }
    ...
    public function terms_and_conditions_update(Request $request)
    {
        ...
        Toastr::success('Mise à jour des termes et conditions');
        return back();
    }
    ...
    public function privacy_policy_update(Request $request)
    {
        ...
        Toastr::success('Politique de confidentialité mise à jour');
        return back();
    }
    ...
    public function about_us_update(Request $request)
    {
        ...
        Toastr::success('A propos de nous mis à jour');
        return back();
    }
    ...
    public function update_fcm(Request $request)
    {
        ...
        Toastr::success('Paramètres mis à jour');
        return back();
    }
    ...
    public function update_fcm_messages(Request $request)
    {
        ...
        Toastr::success('Message mis à jour');
        return back();
    }
