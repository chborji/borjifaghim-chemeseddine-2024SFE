...
<body>
    ...
    <main id="content" role="main" class="main">
        <div class="position-fixed top-0 right-0 left-0 bg-img-hero"style="height: 100%; background-image: url({{asset('assets/admin')}}/svg/components/login-background.png);">
        </div>

        <!-- Content -->
        <div class="container py-5 py-sm-7">
            <a class="d-flex justify-content-center mb-5" href="javascript:">
                <img class="z-index-2" src="{{asset('restaurant')}}/{{\App\Model\BusinessSetting::where(['key'=>'logo'])->first()->value}}" alt="Image Description" style="height: 100px;">
            </a>
                        ...
                        <div class="card-body">
                            ...
                            <form class="js-validate" action="{{route('branch.auth.login')}}" method="post">
                                ...
                                <div class="text-center">
                                    <div class="mb-5">
                                        <h1 class="display-4">User Sign in</h1>
