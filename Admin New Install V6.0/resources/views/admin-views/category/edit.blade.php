            ...
            <form action="{{route('admin.category.update',[$category['id']])}}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <input type="text" name="name" value="{{$category['name']}}" class="form-control" placeholder="Categorie">
                ...
                <div class="col-6">
                    ...
                    <img style="width: 30%;border: 1px solid; border-radius: 10px;" id="viewer" src="{{asset('storage/category')}}/{{$category['image']}}" alt="" />

                </div>
        </div>
        <div class="form-group col-6 mt-3"> <button type="submit" class="btn btn-primary">{{\App\CentralLogics\translate('modifier')}}</button>
        </div>
        </form>
    </div>
    <!-- End Table -->
