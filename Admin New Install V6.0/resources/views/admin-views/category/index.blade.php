        ...
        <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
            <form action="{{route('admin.category.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="row form-group col-6">
                                    ...
                                    <input type="text" name="name" class="form-control" placeholder=" Categorie" required>
                    ...
                    <table class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th style="width: 20%">{{\App\CentralLogics\translate('nom')}}</th>
                                <th style="width: 20%">{{\App\CentralLogics\translate('image')}}</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="d-block font-size-sm text-body">
                                        <img src="{{asset('storage/category/'.$category->image)}}" height="50%" width="50%">
                                    </span>
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item" href="{{route('admin.category.edit',[$category['id']])}}">{{\App\CentralLogics\translate('modifier')}}</a>
                                            <a class="dropdown-item" href="javascript:"onclick="form_alert('category-{{$category['id']}}','Vous voulez supprimer cette catégorie')">{{\App\CentralLogics\translate('supprimer')}}</a>
