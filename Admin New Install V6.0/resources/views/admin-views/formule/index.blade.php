...
<div class="content container-fluid">
    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col-sm mb-2 mb-sm-0">
                <h1 class="page-header-title"><i class="tio-add-circle-outlined"></i> {{\App\CentralLogics\translate('ajouter')}}{{\App\CentralLogics\translate('formule')}}</h1>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-6">
            <div class="form-group lang_form" id="">
                ...
                <input type="text" id="formule-name" name="name[]" class="form-control" placeholder="formule 1" required>
            </div>
            <div class="form-group">
                <label class="input-label" for="exampleFormControlInput1">{{\App\CentralLogics\translate('prix')}}</label>
                <input type="number" id="formule-price" min="0" step="0.01" name="price" class="form-control" placeholder="Ex : 10 TND" required>
            </div>
    ...
    <script>
        ...
        $('#formule_form').on('submit', function() {
            ...
            formData.append("products", JSON.stringify(allProduct))
