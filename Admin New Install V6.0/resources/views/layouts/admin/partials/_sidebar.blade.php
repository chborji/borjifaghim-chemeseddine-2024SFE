            ...
            <div class="navbar-vertical-footer-offset">
                <div class="navbar-brand-wrapper justify-content-between">
                    ...
                    <a class="navbar-brand" href="{{route('admin.dashboard')}}" aria-label="Front">
                        <img class="navbar-brand-logo" src="{{asset('storage/restaurant/'.$restaurant_logo)}}" alt="Logo">
                        <img class="navbar-brand-logo-mini" src="{{asset('storage/restaurant/'.$restaurant_logo)}}" alt="Logo">
                    </a>
...
<!--
                        ...
                        <li class="nav-item">
                            <small class="nav-subtitle">{{\App\CentralLogics\translate('section')}} {{\App\CentralLogics\translate('commandes')}}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>

                        <li class="navbar-vertical-aside-has-menu {{Request::is('admin/orders*')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link " href="{{route('admin.orders.list',['confirmed'])}}">
                                <i class="tio-shopping-cart nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                    {{\App\CentralLogics\translate('commande')}}
                           ...
                           {{--  <a class="nav-link " href="{{route('admin.orders.list',['confirmed'])}}" title="">
                                ...
                                <span class="text-truncate">
                                    {{\App\CentralLogics\translate('Confirmée')}}
                                    <span class="badge badge-soft-success badge-pill ml-1">
                                        {{\App\Model\Order::where(['order_status'=>'confirmed'])->count()}}
                                    </span>
                                </span>
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"style="display: {{Request::is('admin/order*')?'block':'none'}}">
                               {{--  <li class="nav-item {{Request::is('admin/orders/list/all')?'active':''}}">
                                    <a class="nav-link" href="{{route('admin.orders.list',['all'])}}" title="">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">
                                            {{\App\CentralLogics\translate('toutes')}}
                                            <span class="badge badge-info badge-pill ml-1">
                                ...
                                <!--<li class="nav-item {{Request::is('admin/orders/list/pending')?'active':''}}">
                                    <a class="nav-link " href="{{route('admin.orders.list',['pending'])}}" title="">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">
                                            {{\App\CentralLogics\translate('en attente')}}
                      ...
                      {{--           <li class="nav-item {{Request::is('admin/orders/list/confirmed')?'active':''}}">
                             ...
                             <!--   <li class="nav-item {{Request::is('admin/orders/list/processing')?'active':''}}">
                              ...
                              {{--   <li class="nav-item {{Request::is('admin/orders/list/canceled')?'active':''}}">
                                    <a class="nav-link " href="{{route('admin.orders.list',['canceled'])}}" title="">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">
                                            {{\App\CentralLogics\translate('annulée')}}
                        ...
                        <li class="nav-item">
                            <small class="nav-subtitle">{{\App\CentralLogics\translate('section')}} {{\App\CentralLogics\translate('produit')}}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>
                        ...
                        <li class="navbar-vertical-aside-has-menu {{Request::is('admin/category*')?'active':''}}">
                                    ...
                                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{route('admin.category.add')}}" title="add new category">
                                    <i class="tio-category nav-icon"></i>
                                      
                                        <span  class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{\App\CentralLogics\translate('categorie')}}</span>
                                    </a>
                    </li>
                    <!-- End Pages -->
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('admin/attribute*')?'active':''}}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{route('admin.attribute.add-new')}}">
                            ...
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                {{\App\CentralLogics\translate('attribut')}}
                            </span>
                        </a>
                    </li>
                    <!-- End Pages -->
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('admin/addon*')?'active':''}}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{route('admin.addon.add-new')}}">
                            <i class="tio-add-circle-outlined nav-icon"></i>
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                {{\App\CentralLogics\translate('supplément')}}
                            </span>
                        </a>
                    </li>
                    <!-- End Pages -->
                     ...
                     <li class="navbar-vertical-aside-has-menu {{Request::is('admin/ingredient*')?'active':''}}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:">
                            <i class="tio-strawberry nav-icon"></i>
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                {{\App\CentralLogics\translate('ingredient')}}
                            </span>
                        </a>
                        
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"style="display: {{Request::is('admin/ingredient*')?'block':'none'}}">

                        <li class="nav-item {{Request::is('admin/ingcategory*')?'active':''}}">      
                         <a class="nav-link" href="{{route('admin.ingcategory.add')}}" title="add new category">
                         <i class="tio-circle nav-indicator-icon"></i>                  
                             <span  class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{\App\CentralLogics\translate('categorie')}}</span>
                         </a>
                         </li>

                            <li class="nav-item {{Request::is('admin/ingredient/add-new')?'active':''}}">
                                <a class="nav-link " href="{{route('admin.ingredient.add-new')}}" title="add new ingredient">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">{{\App\CentralLogics\translate('ajouter')}}</span>
                                </a>
                            </li>
                               <li class="nav-item {{Request::is('admin/ingredient/list')?'active':''}}">
                                <a class="nav-link " href="{{route('admin.ingredient.list')}}" title="ingredient list">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">{{\App\CentralLogics\translate('liste')}}</span>
                                </a>
                            </li>
                         </ul>
                    </li>
                    <!-- End Pages -->
                     ...
                     <!-- Pages -->
                     <li class="navbar-vertical-aside-has-menu {{Request::is('admin/formule*')?'active':''}}">
                    <!--    <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:">
                            <i class="tio-premium-outlined nav-icon"></i>
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                {{\App\CentralLogics\translate('produit composé')}}
                            </span>
                        </a>-->
                        
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"style="display: {{Request::is('admin/productcompose*')?'block':'none'}}">

                            <li class="nav-item {{Request::is('admin/productcompose/add-new')?'active':''}}">
                                <a class="nav-link " href="{{route('admin.productcompose.add-new')}}" title="add new composed product">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">{{\App\CentralLogics\translate('ajouter')}}</span>
                                </a>
                            </li>
                               <li class="nav-item {{Request::is('admin/productcompose/list')?'active':''}}">
                                <a class="nav-link " href="{{route('admin.productcompose.list')}}" title="Composed product list">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">{{\App\CentralLogics\translate('liste')}}</span>
                                </a>
                            </li>
                    ...
                    <!-- End Pages -->
                     ...
                     <li class="navbar-vertical-aside-has-menu {{Request::is('admin/formule*')?'active':''}}">
                       <!-- <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:">
                            ...
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                {{\App\CentralLogics\translate('formules')}}
                            </span>
                        </a>-->
                        
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"style="display: {{Request::is('admin/formule*')?'block':'none'}}">

                            <li class="nav-item {{Request::is('admin/formule/add')?'active':''}}">
                                <a class="nav-link " href="{{route('admin.formule.add')}}" title="add new formule">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">{{\App\CentralLogics\translate('ajouter')}}</span>
                                </a>
                            </li>
                            <li class="nav-item {{Request::is('admin/formule/list')?'active':''}}">
                                <a class="nav-link " href="{{route('admin.formule.list')}}" title="Composed product list">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">{{\App\CentralLogics\translate('liste')}}</span>
                                </a>
                            </li>
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('admin/product*')?'active':''}}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:">
                            <i class="tio-pizza-outlined nav-icon"></i>
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{\App\CentralLogics\translate('produit')}}</span>
                        </a>
                    ...
                    <li class="nav-item">
                        <small class="nav-subtitle" title="Layouts">{{\App\CentralLogics\translate('section')}} {{\App\CentralLogics\translate('restaurant')}}</small>
                        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                    </li>
                     <!-- Pages -->
                   <!--  <li class="navbar-vertical-aside-has-menu {{Request::is('admin/table*')?'active':''}}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{route('admin.table.add-new')}}">
                            <i class="tio-table nav-icon"></i>
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                {{\App\CentralLogics\translate('table')}}
                            </span>
                        </a>
                    </li>-->
                    <!-- End Pages -->
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('admin/branch*')?'active':''}}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{route('admin.branch.add-new')}}">
                            ...
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                {{\App\CentralLogics\translate('caissier')}}
                            </span>
                        </a>
                    </li>
                    <!-- End Pages -->
                  ...
                  <!--   <li class="navbar-vertical-aside-has-menu {{Request::is('admin/coupon*')?'active':''}}">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('admin/business-settings*')?'active':''}}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:">
                            ...
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{\App\CentralLogics\translate('Paramètres')}}</span>
                        </a>
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"style="display: {{Request::is('admin/business-settings*')?'block':'none'}}">
                            <li class="nav-item {{Request::is('admin/business-settings/restaurant-setup')?'active':''}}">
                                <a class="nav-link " href="{{route('admin.business-settings.restaurant-setup')}}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">{{\App\CentralLogics\translate('Paramètres')}} {{\App\CentralLogics\translate('restaurant')}}</span>
                                </a>
                            </li>
                        </ul>
                          <!--   <li class="nav-item {{Request::is('admin/business-settings/location-setup')?'active':''}}">
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/business-settings/sms-module')?'active':''}}">
                                <a class="nav-link " href="{{route('admin.business-settings.sms-module')}}" title="{{\App\CentralLogics\translate('sms')}} {{\App\CentralLogics\translate('module')}}">
                                    <span class="tio-circle nav-indicator-icon"></span>
...
<!--
                    <li class="nav-item">
                        <small class="nav-subtitle" title="Layouts">{{\App\CentralLogics\translate('deliveryman')}} {{\App\CentralLogics\translate('section')}}</small>
                        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                    </li>
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('admin/delivery-man/reviews/list')?'active':''}}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{route('admin.delivery-man.reviews.list')}}">
                ...
                <!--    <li class="nav-item">
                        <small class="nav-subtitle" title="Documentation">{{\App\CentralLogics\translate('customer')}} {{\App\CentralLogics\translate('section')}}</small>
                        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                    </li>
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('admin/customer/list*')?'active':''}}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{route('admin.customer.list')}}">
                            <i class="tio-standing nav-icon"></i>
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                   ...
                   <!-- <li class="navbar-vertical-aside-has-menu {{Request::is('admin/customer/transaction*')?'active':''}}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{route('admin.customer.transaction')}}">
                  ...
                  <!--  <li class="nav-item">
                        <small class="nav-subtitle" title="Documentation">{{\App\CentralLogics\translate('rapport_et_analytique')}}</small>
                        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                    </li>-->
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('admin/report*')?'active':''}}">
                        <!--<a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:">
                            ...
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{\App\CentralLogics\translate('rapports')}}</span>
                        </a>-->
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"style="display: {{Request::is('admin/report*')?'block':'none'}}">
                            <li class="nav-item {{Request::is('admin/report/earning')?'active':''}}">
                                <a class="nav-link " href="{{route('admin.report.earning')}}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">{{\App\CentralLogics\translate('rapport')}} {{\App\CentralLogics\translate('bénéfices')}}</span>
                                </a>
                            </li>
                            <li class="nav-item {{Request::is('admin/report/order')?'active':''}}">
                                <a class="nav-link " href="{{route('admin.report.order')}}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">{{\App\CentralLogics\translate('rapport')}} {{\App\CentralLogics\translate('commandes')}}</span>
                                </a>
                            </li>
                           <!-- <li class="nav-item {{Request::is('admin/report/driver-report')?'active':''}}">
                                <a class="nav-link " href="{{route('admin.report.driver-report')}}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">{{\App\CentralLogics\translate('driver')}} {{\App\CentralLogics\translate('report')}}</span>
                                </a>
                            </li>-->
                           <li class="nav-item {{Request::is('admin/report/product-report')?'active':''}}">
                                <a class="nav-link " href="{{route('admin.report.product-report')}}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">{{\App\CentralLogics\translate('rapport')}} {{\App\CentralLogics\translate('produit')}}</span>
                                </a>
                            </li>
                            <li class="nav-item {{Request::is('admin/report/sale-report')?'active':''}}">
                                <a class="nav-link " href="{{route('admin.report.sale-report')}}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">{{\App\CentralLogics\translate('rapport')}} {{\App\CentralLogics\translate('vente')}}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
